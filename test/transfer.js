var TFT = artifacts.require('TransferToken');

contract("Testing Transfer function in token", function(accounts){
    it("Should send coin correctly", function() {
        ...
        return TFT.deployed(account_one,account_two).then(function(instance) {
          meta = instance;
