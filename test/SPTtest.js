...
contract("Testing ERC20 Contract with two parameters", function(accounts){
    ...
    it("Return balance owners", function(){
        return SPT.deployed('0xC0b4ec83028307053Fbe8d00ba4372384fe4b52B',
        '0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1').then(
            function(instance){
                return instance.balanceOf.call("0xC0b4ec83028307053Fbe8d00ba4372384fe4b52B")
            }
        ).then(function(result){
